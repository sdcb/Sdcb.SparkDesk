...
public class FunctionCallTests
{
    ...
    public async Task V3_ShouldSupportFunctionCall()
    {
        ...
        await foreach (StreamedChatResponse resp in c.ChatAsStreamAsync(ModelVersion.Pro,
        [
    ...
    {
        SparkDeskClient c = UnitTest1.CreateSparkDeskClient();
        ChatResponse resp = await c.ChatAsync(ModelVersion.Pro,
        [
            ChatMessage.FromSystem("你是用户助理，当前日期：2024-03-09"),
            ChatMessage.FromUser("请问明天长沙天气如何？"),
        ], functions:
    ...
    {
        SparkDeskClient c = UnitTest1.CreateSparkDeskClient();
        ChatResponse resp = await c.ChatAsync(ModelVersion.Max,
        [
            ChatMessage.FromSystem("你是用户助理，当前日期：2024-03-09"),
            ChatMessage.FromUser("请问明天长沙天气如何？"),
    ...
    {
        SparkDeskClient c = UnitTest1.CreateSparkDeskClient();
        await foreach (StreamedChatResponse resp in c.ChatAsStreamAsync(ModelVersion.Max,
        [
            ChatMessage.FromSystem("你是用户助理，当前日期：2024-03-09"),
            ChatMessage.FromUser("请问明天长沙天气如何？"),
            ChatMessage.FromUser("""
    ...
    [Fact]
    public async Task V4_ShouldSupportFunctionCall_ResponseStreamed()
    {
        SparkDeskClient c = UnitTest1.CreateSparkDeskClient();
        await foreach (StreamedChatResponse resp in c.ChatAsStreamAsync(ModelVersion.V4_0_Ultra,
        [
            ChatMessage.FromSystem("你是用户助理，当前日期：2024-03-09"),
            ChatMessage.FromUser("请问明天长沙天气如何？"),
            ChatMessage.FromUser("""
